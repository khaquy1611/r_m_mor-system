...
const DashboardChartFinance = () => {
  ...
  return (
    <Box className={clsx(classes.blockChart)}>
      <CardForm title={i18nCommon('TITLE_REVENUE')} className="chart">
        <ConditionalRender
      ...
      <CardForm title={i18nCommon('TITLE_COST')}>
        <ConditionalRender
      ...
      <CardForm title={i18nCommon('TITLE_PROFIT')}>
        <ConditionalRender
      ...
      <CardForm title={i18nCommon('TITLE_KPI')}>
        <ConditionalRender
